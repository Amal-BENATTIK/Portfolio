  ...
  return(
    <div>
      <div style={{marginTop:'50px',marginBottom:'50px',}}>
        <h1 style={{color:'white'}}>It's me BENATTIK Amal</h1>
        <p style={{ color: '#bbb', paddingInline:'90px' }}>
      ...
      <div style={{marginInline:'50px',marginTop:'50px',marginBottom:'50px',}}>
      ...
      <div style={{marginInline:'50px',marginTop:'100px',marginBottom:'100px',}}>
        <h2 style={{marginBottom:'60px', color:'white',}}>Professional Experinces</h2>
        <div class="grid">
          <div class="col" >
            <Fieldset legend="InternShip March 2019" style={{height:'400px'}}>
              <p className="m-0">
          ...
          <div class="col" >
          <Fieldset legend="InternShip March 2020" style={{height:'400px'}}>
              <p className="m-0">
          ...
          <div class="col" >
          <Fieldset legend="InternShip June 2022" style={{height:'400px'}}>
              <p className="m-0">
      ...
      <div style={{marginInline:'50px',}}>
        ...
        <div className="surface-0 text-center" style={{marginTop:'100px',marginBottom:'50px',}}>
